 ...
 */
export function htlcsFromOfferAccept(offer, accept) {
 ...
 */
export function verifyFundedBtc(offer, accept, funded) {
...
export function verifyFundedFbc(offer, accept, funded) {
    if (funded.offer_id !== offer.offer_id) {
        return { ok: false, reason: "offer_id mismatch" };
    }
